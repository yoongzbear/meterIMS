...
<p>Please scan the QR code on the water meter to view the information</p>
    ...
    <form id="meterForm" action="RegDep_view_meter_info.php" method="post" style="display:none;">
    ...
    <script>
        ...
        document.getElementById("btn-cancel").addEventListener("click", function(event) {
            ...
            window.location.href = 'Reg_QRmenu.php';
        });
    </script>
    ...
    <button type="button" onclick="window.location.href='Reg_QRmenu.php'">Back</button>
