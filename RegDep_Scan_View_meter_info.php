...
<div class="my-4 text-center">
    ...
    <h3>View Meter Infomation</h3>
    <p class="fst-italic">Please scan the QR code to view the meter information</p>
    ...
    <div class="modal-content rounded-3 shadow" id="meterForm" action="reg_check_serial_num_view_meterInfo.php" method="POST" style="display:none;">
            <form id="meterSubmitForm" action="reg_check_serial_num_view_meterInfo.php" method="POST">
                <div class="modal-body p-4 text-center">
                    <h5 class="modal-title mb-0" id="meterFormLabel">Is this the right serial number for the meter?</h5>
...
<script>
    ...
    document.getElementById("btn-cancel").addEventListener("click", function(event) {
        ...
        window.location.href = 'RegDep_Scan_View_meter_info.php';
    });
</script>
