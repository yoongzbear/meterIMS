...
if(isset($_POST['batch_id'])) {
    ...
    $query2 = "SELECT batch.*, movement.* FROM batch JOIN movement ON batch.batch_id = movement.batch_id WHERE movement.batch_id = '$batch_id' AND inbound_id IN (1, 3, 4, 5) ORDER BY movement.tracking_id DESC LIMIT 1";
    ...
    if(mysqli_num_rows($result) > 0 ) {
        if(mysqli_num_rows($result1) == 0 && mysqli_num_rows($result2) == 0) {
            ...
            // Batch ID exists but has not been received at test lab
