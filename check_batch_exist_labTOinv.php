...
if(isset($_POST['batch_id'])) {
    ...
    if(mysqli_num_rows($passresult) > 0) {
        ...
        // No rows returned from the pass batch query, indicating failure
        echo '<script>alert("The failed batch cannot be shipped out to the inventory department."); window.location.href = "LabDep_Scan_to_Inv.php";</script>';
    }
}
?>
