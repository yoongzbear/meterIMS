...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("addAnother").addEventListener("click", function() {
            window.location.href = "inventoryDep_ShipOrderScanMeterQR.php?Batch_ID=<?php echo $newBatch_id; ?>&meterQuantity=<?php echo $meterQuantity; ?>";
        });

        document.getElementById("complete").addEventListener("click", function() {
            window.location.href = "inventoryDep_ShipAddMeterComplete.php?Batch_ID=<?php echo $newBatch_id; ?>";
        });
    });
</script>
