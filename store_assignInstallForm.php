...
<div class="my-4 text-center">
    ...
    <div class="modal-content rounded-3 shadow" id="meterForm" action="store_assignInstall.php" method="get" style="display:none;">
            <form id="meterSubmitForm" action="store_assignInstall.php" method="get">
