...
<body>
    <h1>Meter Replacement Form</h1>
    <p>Please scan the QR code on the new water meter</p>
    ...
    <form id="meterForm" action="store_replaceCheckQR.php" method="get" style="display:none;">
